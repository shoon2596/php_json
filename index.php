	...
	<script>
		$(document).ready(function(){
				...
				$.get('student.json',function(response){
					if(response){
						...
						$.each(stuArray,function(i,v){
							...
							<td>${v.email}</td>
							<td>
							<button class="btn btn-primary btn-sm detail" data-id="${i}"
							data-name="${v.name}" data-gender="${v.gender}" data-email="${v.email}" data-addres="${v.address}" data-profile="${v.profile}"> 
							Detail</button>
			...
			$("tbody").on("click",".detail",function(){
				...
				$("#stu_email").text("Name:"+email);
				$("#stu_gender").text("Name:"+gender);
				$("#stu_address").text("Name:"+address);
